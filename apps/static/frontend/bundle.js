...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 15, 1, 302);
    			add_location(h3, file, 17, 1, 327);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		let response = await fetch("/api/greet").then(resultat => resultat.json());
    		console.log(response);
    		$$invalidate(1, apimessage = JSON.stringify(response));
    	});
